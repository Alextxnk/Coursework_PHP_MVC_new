<div class="col-span-1">
    <div class="overflow-y-auto py-4 px-3 bg-gray-100 rounded dark:bg-gray-800">
        <ul class="space-y-2 left-menu">
            <li>
                <a class="<?= trim($_SERVER['REQUEST_URI'], '/') == 'admin' ? 'active' : '' ?>
                w-full inline-flex" href="/admin">
            ...
            <li>
                <a class="<?= trim($_SERVER['REQUEST_URI'], '/') == 'admin/main' ? 'active' : '' ?>
                w-full inline-flex" href="/admin/main">
            ...
            <li>
                <a class="
                <?= trim($_SERVER['REQUEST_URI'], '/') == 'admin/author' ? 'active' : '' ?>
                w-full inline-flex" href="/admin/author">
                    <svg class="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z"></path>
                        <path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z"></path>
                    </svg>
                    <span class="ml-3">Об авторе</span>
                </a>
            </li>
            <li>
                <a class="
                <?= trim($_SERVER['REQUEST_URI'], '/') == 'admin/firm' ? 'active' : '' ?>
                w-full inline-flex" href="/admin/firm">
                    <svg class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM11 13a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z">
                        </path>
                    </svg>
                    <span class="ml-3">О фирме</span>
                </a>
            </li>
            <li>
                <a class="
                <?= trim($_SERVER['REQUEST_URI'], '/') == 'admin/camera' ? 'active' : '' ?>
                w-full inline-flex" href="/admin/camera">
                    <svg class="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z"></path>
                        <path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z"></path>
                    </svg>
                    <span class="ml-3">Фотоаппараты</span>
                </a>
            </li>
            <li>
                <a class="
                <?= trim($_SERVER['REQUEST_URI'], '/') == 'lens' ? 'active' : '' ?>
                w-full inline-flex" href="/lens">
                    <svg class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM11 13a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z">
                        </path>
                    </svg>
                    <span class="ml-3">Объективы</span>
                </a>
            </li>
            <li>
                <a class="
                <?= trim($_SERVER['REQUEST_URI'], '/') == 'flash' ? 'active' : '' ?>
                w-full inline-flex" href="/flash">
                    <svg class="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z"></path>
                        <path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z"></path>
                    </svg>
                    <span class="ml-3">Вспышки</span>
                </a>
            </li>
            <li>
                <a class="
                <?= trim($_SERVER['REQUEST_URI'], '/') == 'users' ? 'active' : '' ?>
                w-full inline-flex" href="/users">
                    <svg class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM11 13a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z">
                        </path>
                    </svg>
            ...
            <li>
                <form class="cursor-pointer w-full inline-flex" action="/logout" method="post">
                    ...
                    <button class="flex-1 ml-3 whitespace-nowrap text-left white" type="submit">
                        Выйти
                    </button>
                </form>
            </li>
