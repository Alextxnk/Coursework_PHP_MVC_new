                                ...
                                <div class="w-full">
                                    ...
                                    <form id="updatePost" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <select name="category_id[]" id="" multiple class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
