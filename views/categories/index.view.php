                ...
                <div class="p-6 bg-white border-b border-gray-200 md:grid md:grid-cols-5 gap-4">
                    ...
                    <div class="col-span-4">
                        <div class="flex justify-between mb-4">
                            ...
                            <a href="/categories/create" class="px-4 py-2 bg-yellow-600 rounded-sm text-white">Add
                                Category</a>
                        </div>
                                    ...
                                    <?php foreach ($categories as $category) : ?>
                                        ...
                                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                            ...
                                            <td class="px-6 py-4 flex">
                                                <form action="/categories/edit" method="GET">
                                                ...
                                                <form action="/categories/delete" method="POST" class="mx-4 cursor-pointer">
                                                    <input type="hidden" name="id" value="<?= $category->id; ?>">
                                                    <button type="submit">
