                    ...
                    <div class="p-6 bg-white border-b border-gray-200 md:grid md:grid-cols-5 gap-4">
                        ...
                        <div class="col-span-4">
                            <div class="flex justify-between mb-4">
                                <h3 class="mb-4 text-xl font-bold">Объективы</h3>
                                <a href="/admin/lens/create" class="px-4 py-2 bg-yellow-600 rounded-sm text-white">Добавить Объектив</a>
                            </div>
                                    ...
                                    <?php foreach ($lens as $lens) : ?>
                                        ...
                                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                            ...
                                            <td class="px-6 py-4 flex">
                                                <form action="/admin/lens/edit" method="GET">
                                                ...
                                                <form action="/admin/lens/delete" method="POST" class="mx-4 cursor-pointer">
                                                    <input type="hidden" name="id" value="<?= $lens->id; ?>">
                                                    <button type="submit">
                                                ...
                                                <form action="/admin/lens/view" method="GET">
                                                    <input type="hidden" name="id" value="<?= $lens->id; ?>">
                                                    <button type="submit">
